...
이 문서는 새영동숯불갈비 프로젝트의 개발 단계를 정의합니다.
...
- [x] 다국어 번역 검수 (특히 영문/중문 i18n 처리 안되어있는 부분 체크 특히, 메뉴 부분 UI에서 자연스러움 확인)
- [x] SEO 메타 태그 (Title, Description, OG Image 설정 기반 마련)
...
- [x] Vercel 프로덕션 배포 완료 (Preview: https://saeyoungdong.vercel.app)
- [ ] 운영 도메인 연결 확인 (https://새영동갈비.com, DNS 전파 대기 중)
